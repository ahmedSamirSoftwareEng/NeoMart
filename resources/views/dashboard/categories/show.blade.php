...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><i class="fas fa-folder-open me-2"></i>Category: {{ $category->name }}</h4>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-6">
                    <p><strong>Description:</strong><br> {{ $category->description ?? 'N/A' }}</p>
                    ...
                    <p><strong>Parent Category:</strong><br>
                        {{ $category->parent ? $category->parent->name : 'None (Primary Category)' }}
                    </p>
                </div>
                <div class="col-md-6 text-center">
                    @if ($category->image)
                        <img src="{{ asset('storage/' . $category->image) }}" alt="Category Image" class="img-fluid rounded shadow-sm" style="max-height: 200px;">
                    @else
            ...
            <h5 class="mb-3"><i class="fas fa-boxes me-2"></i>Products in this Category</h5>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <p class="text-muted mb-0">Start by adding a new product to this category.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
