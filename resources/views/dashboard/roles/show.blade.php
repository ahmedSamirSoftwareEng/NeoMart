...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><i class="fas fa-folder-open me-2"></i>Role: {{ $role->name }}</h4>
        </div>
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-6">
                    <p><strong>Description:</strong><br> {{ $role->description ?? 'N/A' }}</p>
                    ...
                    <p><strong>Parent Role:</strong><br>
                        {{ $role->parent ? $role->parent->name : 'None (Primary Role)' }}
                    </p>
                </div>
                <div class="col-md-6 text-center">
                    @if ($role->image)
                        <img src="{{ asset('storage/' . $role->image) }}" alt="Role Image" class="img-fluid rounded shadow-sm" style="max-height: 200px;">
                    @else
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <p class="text-muted mb-0">Start by adding a new product to this role.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
