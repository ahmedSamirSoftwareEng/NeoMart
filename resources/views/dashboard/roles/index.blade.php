...
<div class="card shadow-sm">
    <div class="card-header bg-white py-3">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <a href="{{ route('dashboard.roles.create') }}" class="btn btn-success btn-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <small>{{ $role->created_at->format('d M Y') }}</small><br>
                    ...
                    <tr>
                        <td colspan="9" class="text-center py-4"> {{-- Corrected colspan to 7 --}}
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <p class="text-muted mb-0">Create your first role by clicking the button
                                    above
                                </p>
                            </div>
                        </td>
