                    ...
                    <tbody>
                        @forelse ($categories as $category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <small>{{ $category->deleted_at->format('d M Y') }}</small><br>
                                    <small class="text-muted">{{ $category->deleted_at->format('h:i A') }}</small>
                                </td>
                                <td class="text-center">
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <p class="text-muted mb-0">No deleted categories found.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
